...
class TestParse(BaseTest):
    def test_parse_variation_string(self):
        result = simulation_data.parse_number_with_uint("abc")
        assert result == ("abc", "")

        result = simulation_data.parse_number_with_uint("")
        assert result == ("", "")

        result = simulation_data.parse_number_with_uint("3m2")
        assert result == ("3", "m2")

        result = simulation_data.parse_number_with_uint("3.12345678901234mH")
        assert result == ("3.123456789e+00", "mH")

        result = simulation_data.parse_number_with_uint("3.1234567891e-9mH")
        assert result == ("3.123456789e-09", "mH")

        result = simulation_data.parse_number_with_uint("3.1234567891e-111mH")
        assert result == ("3.123456789e-111", "mH")

        result = simulation_data.parse_number_with_uint("3")
        assert result == ("3", "")

        result = simulation_data.parse_number_with_uint("3.0")
        assert result == ("3.0", "")
